...
func (b *VBottomSheetBuilder) SetSlot(name string, child ...h.HTMLComponent) {
	b.AppendChild(h.Template(child...).Attr("v-slot:"+name, true).Attr())
}

func (b *VBottomSheetBuilder) SetScopedSlot(name string, scope string, child ...h.HTMLComponent) {
	b.AppendChild(h.Template(child...).Attr("v-slot:"+name, scope).Attr())
}

func (b *VBottomSheetBuilder) Slot(name string, child ...h.HTMLComponent) (r *VBottomSheetBuilder) {
	b.SetSlot(name, child...)
	return b
}

func (b *VBottomSheetBuilder) ScopedSlot(name string, scope string, child ...h.HTMLComponent) (r *VBottomSheetBuilder) {
	b.SetScopedSlot(name, scope, child...)
	return b
}

func (b *VBottomSheetBuilder) SetSlotDefault(child ...h.HTMLComponent) {
	b.SetSlot("default", child...)
}

func (b *VBottomSheetBuilder) SetScopedSlotDefault(scope string, child ...h.HTMLComponent) {
	b.SetScopedSlot("default", scope, child...)
}

func (b *VBottomSheetBuilder) SlotDefault(child ...h.HTMLComponent) (r *VBottomSheetBuilder) {
	b.SetSlotDefault(child...)
	return b
}

func (b *VBottomSheetBuilder) ScopedSlotDefault(scope string, child ...h.HTMLComponent) (r *VBottomSheetBuilder) {
	b.SetScopedSlotDefault(scope, child...)
	return b
}

func (b *VBottomSheetBuilder) SetSlotActivator(child ...h.HTMLComponent) {
	b.SetSlot("activator", child...)
}

func (b *VBottomSheetBuilder) SetScopedSlotActivator(scope string, child ...h.HTMLComponent) {
	b.SetScopedSlot("activator", scope, child...)
}

func (b *VBottomSheetBuilder) SlotActivator(child ...h.HTMLComponent) (r *VBottomSheetBuilder) {
	b.SetSlotActivator(child...)
	return b
}

func (b *VBottomSheetBuilder) ScopedSlotActivator(scope string, child ...h.HTMLComponent) (r *VBottomSheetBuilder) {
