...
func (b *VFabBuilder) Tag(v interface{}) (r *VFabBuilder) {
...
func (b *VFabBuilder) Text(v interface{}) (r *VFabBuilder) {
...
func (b *VFabBuilder) ActiveColor(v string) (r *VFabBuilder) {
...
func (b *VFabBuilder) SetSlot(name string, child ...h.HTMLComponent) {
	b.AppendChild(h.Template(child...).Attr("v-slot:"+name, true).Attr())
}

func (b *VFabBuilder) SetScopedSlot(name string, scope string, child ...h.HTMLComponent) {
	b.AppendChild(h.Template(child...).Attr("v-slot:"+name, scope).Attr())
}

func (b *VFabBuilder) Slot(name string, child ...h.HTMLComponent) (r *VFabBuilder) {
	b.SetSlot(name, child...)
	return b
}

func (b *VFabBuilder) ScopedSlot(name string, scope string, child ...h.HTMLComponent) (r *VFabBuilder) {
	b.SetScopedSlot(name, scope, child...)
	return b
}

func (b *VFabBuilder) SetSlotDefault(child ...h.HTMLComponent) {
	b.SetSlot("default", child...)
}

func (b *VFabBuilder) SetScopedSlotDefault(scope string, child ...h.HTMLComponent) {
	b.SetScopedSlot("default", scope, child...)
}

func (b *VFabBuilder) SlotDefault(child ...h.HTMLComponent) (r *VFabBuilder) {
	b.SetSlotDefault(child...)
	return b
}

func (b *VFabBuilder) ScopedSlotDefault(scope string, child ...h.HTMLComponent) (r *VFabBuilder) {
