...
func (b *VSnackbarBuilder) SetSlot(name string, child ...h.HTMLComponent) {
	b.AppendChild(h.Template(child...).Attr("v-slot:"+name, true).Attr())
}

func (b *VSnackbarBuilder) SetScopedSlot(name string, scope string, child ...h.HTMLComponent) {
	b.AppendChild(h.Template(child...).Attr("v-slot:"+name, scope).Attr())
}

func (b *VSnackbarBuilder) Slot(name string, child ...h.HTMLComponent) (r *VSnackbarBuilder) {
	b.SetSlot(name, child...)
	return b
}

func (b *VSnackbarBuilder) ScopedSlot(name string, scope string, child ...h.HTMLComponent) (r *VSnackbarBuilder) {
	b.SetScopedSlot(name, scope, child...)
	return b
}

func (b *VSnackbarBuilder) SetSlotActivator(child ...h.HTMLComponent) {
	b.SetSlot("activator", child...)
}

func (b *VSnackbarBuilder) SetScopedSlotActivator(scope string, child ...h.HTMLComponent) {
	b.SetScopedSlot("activator", scope, child...)
}

func (b *VSnackbarBuilder) SlotActivator(child ...h.HTMLComponent) (r *VSnackbarBuilder) {
	b.SetSlotActivator(child...)
	return b
}

func (b *VSnackbarBuilder) ScopedSlotActivator(scope string, child ...h.HTMLComponent) (r *VSnackbarBuilder) {
	b.SetScopedSlotActivator(scope, child...)
	return b
}

func (b *VSnackbarBuilder) SetSlotDefault(child ...h.HTMLComponent) {
	b.SetSlot("default", child...)
}

func (b *VSnackbarBuilder) SetScopedSlotDefault(scope string, child ...h.HTMLComponent) {
	b.SetScopedSlot("default", scope, child...)
}

func (b *VSnackbarBuilder) SlotDefault(child ...h.HTMLComponent) (r *VSnackbarBuilder) {
	b.SetSlotDefault(child...)
	return b
}

func (b *VSnackbarBuilder) ScopedSlotDefault(scope string, child ...h.HTMLComponent) (r *VSnackbarBuilder) {
	b.SetScopedSlotDefault(scope, child...)
	return b
}

func (b *VSnackbarBuilder) SetSlotActions(child ...h.HTMLComponent) {
	b.SetSlot("actions", child...)
}

func (b *VSnackbarBuilder) SetScopedSlotActions(scope string, child ...h.HTMLComponent) {
	b.SetScopedSlot("actions", scope, child...)
}

func (b *VSnackbarBuilder) SlotActions(child ...h.HTMLComponent) (r *VSnackbarBuilder) {
	b.SetSlotActions(child...)
	return b
}

func (b *VSnackbarBuilder) ScopedSlotActions(scope string, child ...h.HTMLComponent) (r *VSnackbarBuilder) {
	b.SetScopedSlotActions(scope, child...)
	return b
}

func (b *VSnackbarBuilder) SetSlotText(child ...h.HTMLComponent) {
	b.SetSlot("text", child...)
}

func (b *VSnackbarBuilder) SetScopedSlotText(scope string, child ...h.HTMLComponent) {
	b.SetScopedSlot("text", scope, child...)
}

func (b *VSnackbarBuilder) SlotText(child ...h.HTMLComponent) (r *VSnackbarBuilder) {
	b.SetSlotText(child...)
	return b
}

func (b *VSnackbarBuilder) ScopedSlotText(scope string, child ...h.HTMLComponent) (r *VSnackbarBuilder) {
