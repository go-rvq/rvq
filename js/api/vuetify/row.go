...
func (b *VRowBuilder) Tag(v interface{}) (r *VRowBuilder) {
...
func (b *VRowBuilder) SetSlot(name string, child ...h.HTMLComponent) {
	b.AppendChild(h.Template(child...).Attr("v-slot:"+name, true).Attr())
}

func (b *VRowBuilder) SetScopedSlot(name string, scope string, child ...h.HTMLComponent) {
	b.AppendChild(h.Template(child...).Attr("v-slot:"+name, scope).Attr())
}

func (b *VRowBuilder) Slot(name string, child ...h.HTMLComponent) (r *VRowBuilder) {
	b.SetSlot(name, child...)
	return b
}

func (b *VRowBuilder) ScopedSlot(name string, scope string, child ...h.HTMLComponent) (r *VRowBuilder) {
	b.SetScopedSlot(name, scope, child...)
	return b
}

func (b *VRowBuilder) SetSlotDefault(child ...h.HTMLComponent) {
	b.SetSlot("default", child...)
}

func (b *VRowBuilder) SetScopedSlotDefault(scope string, child ...h.HTMLComponent) {
	b.SetScopedSlot("default", scope, child...)
}

func (b *VRowBuilder) SlotDefault(child ...h.HTMLComponent) (r *VRowBuilder) {
	b.SetSlotDefault(child...)
	return b
}

func (b *VRowBuilder) ScopedSlotDefault(scope string, child ...h.HTMLComponent) (r *VRowBuilder) {
