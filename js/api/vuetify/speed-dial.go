...
func (b *VSpeedDialBuilder) Submenu(v bool) (r *VSpeedDialBuilder) {
...
func (b *VSpeedDialBuilder) SetSlot(name string, child ...h.HTMLComponent) {
	b.AppendChild(h.Template(child...).Attr("v-slot:"+name, true).Attr())
}

func (b *VSpeedDialBuilder) SetScopedSlot(name string, scope string, child ...h.HTMLComponent) {
	b.AppendChild(h.Template(child...).Attr("v-slot:"+name, scope).Attr())
}

func (b *VSpeedDialBuilder) Slot(name string, child ...h.HTMLComponent) (r *VSpeedDialBuilder) {
	b.SetSlot(name, child...)
	return b
}

func (b *VSpeedDialBuilder) ScopedSlot(name string, scope string, child ...h.HTMLComponent) (r *VSpeedDialBuilder) {
	b.SetScopedSlot(name, scope, child...)
	return b
}

func (b *VSpeedDialBuilder) SetSlotDefault(child ...h.HTMLComponent) {
	b.SetSlot("default", child...)
}

func (b *VSpeedDialBuilder) SetScopedSlotDefault(scope string, child ...h.HTMLComponent) {
	b.SetScopedSlot("default", scope, child...)
}

func (b *VSpeedDialBuilder) SlotDefault(child ...h.HTMLComponent) (r *VSpeedDialBuilder) {
	b.SetSlotDefault(child...)
	return b
}

func (b *VSpeedDialBuilder) ScopedSlotDefault(scope string, child ...h.HTMLComponent) (r *VSpeedDialBuilder) {
	b.SetScopedSlotDefault(scope, child...)
	return b
}

func (b *VSpeedDialBuilder) SetSlotActivator(child ...h.HTMLComponent) {
	b.SetSlot("activator", child...)
}

func (b *VSpeedDialBuilder) SetScopedSlotActivator(scope string, child ...h.HTMLComponent) {
	b.SetScopedSlot("activator", scope, child...)
}

func (b *VSpeedDialBuilder) SlotActivator(child ...h.HTMLComponent) (r *VSpeedDialBuilder) {
	b.SetSlotActivator(child...)
	return b
}

func (b *VSpeedDialBuilder) ScopedSlotActivator(scope string, child ...h.HTMLComponent) (r *VSpeedDialBuilder) {
