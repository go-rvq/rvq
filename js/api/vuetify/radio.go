...
func (b *VRadioBuilder) SetSlot(name string, child ...h.HTMLComponent) {
	b.AppendChild(h.Template(child...).Attr("v-slot:"+name, true).Attr())
}

func (b *VRadioBuilder) SetScopedSlot(name string, scope string, child ...h.HTMLComponent) {
	b.AppendChild(h.Template(child...).Attr("v-slot:"+name, scope).Attr())
}

func (b *VRadioBuilder) Slot(name string, child ...h.HTMLComponent) (r *VRadioBuilder) {
	b.SetSlot(name, child...)
	return b
}

func (b *VRadioBuilder) ScopedSlot(name string, scope string, child ...h.HTMLComponent) (r *VRadioBuilder) {
	b.SetScopedSlot(name, scope, child...)
	return b
}

func (b *VRadioBuilder) SetSlotDefault(child ...h.HTMLComponent) {
	b.SetSlot("default", child...)
}

func (b *VRadioBuilder) SetScopedSlotDefault(scope string, child ...h.HTMLComponent) {
	b.SetScopedSlot("default", scope, child...)
}

func (b *VRadioBuilder) SlotDefault(child ...h.HTMLComponent) (r *VRadioBuilder) {
	b.SetSlotDefault(child...)
	return b
}

func (b *VRadioBuilder) ScopedSlotDefault(scope string, child ...h.HTMLComponent) (r *VRadioBuilder) {
	b.SetScopedSlotDefault(scope, child...)
	return b
}

func (b *VRadioBuilder) SetSlotLabel(child ...h.HTMLComponent) {
	b.SetSlot("label", child...)
}

func (b *VRadioBuilder) SetScopedSlotLabel(scope string, child ...h.HTMLComponent) {
	b.SetScopedSlot("label", scope, child...)
}

func (b *VRadioBuilder) SlotLabel(child ...h.HTMLComponent) (r *VRadioBuilder) {
	b.SetSlotLabel(child...)
	return b
}

func (b *VRadioBuilder) ScopedSlotLabel(scope string, child ...h.HTMLComponent) (r *VRadioBuilder) {
	b.SetScopedSlotLabel(scope, child...)
	return b
}

func (b *VRadioBuilder) SetSlotInput(child ...h.HTMLComponent) {
	b.SetSlot("input", child...)
}

func (b *VRadioBuilder) SetScopedSlotInput(scope string, child ...h.HTMLComponent) {
	b.SetScopedSlot("input", scope, child...)
}

func (b *VRadioBuilder) SlotInput(child ...h.HTMLComponent) (r *VRadioBuilder) {
	b.SetSlotInput(child...)
	return b
}

func (b *VRadioBuilder) ScopedSlotInput(scope string, child ...h.HTMLComponent) (r *VRadioBuilder) {
