...
func (b *VBottomNavigationBuilder) Tag(v interface{}) (r *VBottomNavigationBuilder) {
...
func (b *VBottomNavigationBuilder) Max(v interface{}) (r *VBottomNavigationBuilder) {
...
func (b *VBottomNavigationBuilder) SetSlot(name string, child ...h.HTMLComponent) {
	b.AppendChild(h.Template(child...).Attr("v-slot:"+name, true).Attr())
}

func (b *VBottomNavigationBuilder) SetScopedSlot(name string, scope string, child ...h.HTMLComponent) {
	b.AppendChild(h.Template(child...).Attr("v-slot:"+name, scope).Attr())
}

func (b *VBottomNavigationBuilder) Slot(name string, child ...h.HTMLComponent) (r *VBottomNavigationBuilder) {
	b.SetSlot(name, child...)
	return b
}

func (b *VBottomNavigationBuilder) ScopedSlot(name string, scope string, child ...h.HTMLComponent) (r *VBottomNavigationBuilder) {
	b.SetScopedSlot(name, scope, child...)
	return b
}

func (b *VBottomNavigationBuilder) SetSlotDefault(child ...h.HTMLComponent) {
	b.SetSlot("default", child...)
}

func (b *VBottomNavigationBuilder) SetScopedSlotDefault(scope string, child ...h.HTMLComponent) {
	b.SetScopedSlot("default", scope, child...)
}

func (b *VBottomNavigationBuilder) SlotDefault(child ...h.HTMLComponent) (r *VBottomNavigationBuilder) {
	b.SetSlotDefault(child...)
	return b
}

func (b *VBottomNavigationBuilder) ScopedSlotDefault(scope string, child ...h.HTMLComponent) (r *VBottomNavigationBuilder) {
