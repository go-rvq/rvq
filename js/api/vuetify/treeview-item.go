...
func (b *VTreeviewItemBuilder) Tag(v interface{}) (r *VTreeviewItemBuilder) {
...
func (b *VTreeviewItemBuilder) SetSlot(name string, child ...h.HTMLComponent) {
	b.AppendChild(h.Template(child...).Attr("v-slot:"+name, true).Attr())
}

func (b *VTreeviewItemBuilder) SetScopedSlot(name string, scope string, child ...h.HTMLComponent) {
	b.AppendChild(h.Template(child...).Attr("v-slot:"+name, scope).Attr())
}

func (b *VTreeviewItemBuilder) Slot(name string, child ...h.HTMLComponent) (r *VTreeviewItemBuilder) {
	b.SetSlot(name, child...)
	return b
}

func (b *VTreeviewItemBuilder) ScopedSlot(name string, scope string, child ...h.HTMLComponent) (r *VTreeviewItemBuilder) {
	b.SetScopedSlot(name, scope, child...)
	return b
}

func (b *VTreeviewItemBuilder) SetSlotPrepend(child ...h.HTMLComponent) {
	b.SetSlot("prepend", child...)
}

func (b *VTreeviewItemBuilder) SetScopedSlotPrepend(scope string, child ...h.HTMLComponent) {
	b.SetScopedSlot("prepend", scope, child...)
}

func (b *VTreeviewItemBuilder) SlotPrepend(child ...h.HTMLComponent) (r *VTreeviewItemBuilder) {
	b.SetSlotPrepend(child...)
	return b
}

func (b *VTreeviewItemBuilder) ScopedSlotPrepend(scope string, child ...h.HTMLComponent) (r *VTreeviewItemBuilder) {
	b.SetScopedSlotPrepend(scope, child...)
	return b
}

func (b *VTreeviewItemBuilder) SetSlotAppend(child ...h.HTMLComponent) {
	b.SetSlot("append", child...)
}

func (b *VTreeviewItemBuilder) SetScopedSlotAppend(scope string, child ...h.HTMLComponent) {
	b.SetScopedSlot("append", scope, child...)
}

func (b *VTreeviewItemBuilder) SlotAppend(child ...h.HTMLComponent) (r *VTreeviewItemBuilder) {
	b.SetSlotAppend(child...)
	return b
}

func (b *VTreeviewItemBuilder) ScopedSlotAppend(scope string, child ...h.HTMLComponent) (r *VTreeviewItemBuilder) {
	b.SetScopedSlotAppend(scope, child...)
	return b
}

func (b *VTreeviewItemBuilder) SetSlotDefault(child ...h.HTMLComponent) {
	b.SetSlot("default", child...)
}

func (b *VTreeviewItemBuilder) SetScopedSlotDefault(scope string, child ...h.HTMLComponent) {
	b.SetScopedSlot("default", scope, child...)
}

func (b *VTreeviewItemBuilder) SlotDefault(child ...h.HTMLComponent) (r *VTreeviewItemBuilder) {
	b.SetSlotDefault(child...)
	return b
}

func (b *VTreeviewItemBuilder) ScopedSlotDefault(scope string, child ...h.HTMLComponent) (r *VTreeviewItemBuilder) {
	b.SetScopedSlotDefault(scope, child...)
	return b
}

func (b *VTreeviewItemBuilder) SetSlotTitle(child ...h.HTMLComponent) {
	b.SetSlot("title", child...)
}

func (b *VTreeviewItemBuilder) SetScopedSlotTitle(scope string, child ...h.HTMLComponent) {
	b.SetScopedSlot("title", scope, child...)
}

func (b *VTreeviewItemBuilder) SlotTitle(child ...h.HTMLComponent) (r *VTreeviewItemBuilder) {
	b.SetSlotTitle(child...)
	return b
}

func (b *VTreeviewItemBuilder) ScopedSlotTitle(scope string, child ...h.HTMLComponent) (r *VTreeviewItemBuilder) {
	b.SetScopedSlotTitle(scope, child...)
	return b
}

func (b *VTreeviewItemBuilder) SetSlotSubtitle(child ...h.HTMLComponent) {
	b.SetSlot("subtitle", child...)
}

func (b *VTreeviewItemBuilder) SetScopedSlotSubtitle(scope string, child ...h.HTMLComponent) {
	b.SetScopedSlot("subtitle", scope, child...)
}

func (b *VTreeviewItemBuilder) SlotSubtitle(child ...h.HTMLComponent) (r *VTreeviewItemBuilder) {
	b.SetSlotSubtitle(child...)
	return b
}

func (b *VTreeviewItemBuilder) ScopedSlotSubtitle(scope string, child ...h.HTMLComponent) (r *VTreeviewItemBuilder) {
