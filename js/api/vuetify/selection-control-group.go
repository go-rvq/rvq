...
func (b *VSelectionControlGroupBuilder) SetSlot(name string, child ...h.HTMLComponent) {
	b.AppendChild(h.Template(child...).Attr("v-slot:"+name, true).Attr())
}

func (b *VSelectionControlGroupBuilder) SetScopedSlot(name string, scope string, child ...h.HTMLComponent) {
	b.AppendChild(h.Template(child...).Attr("v-slot:"+name, scope).Attr())
}

func (b *VSelectionControlGroupBuilder) Slot(name string, child ...h.HTMLComponent) (r *VSelectionControlGroupBuilder) {
	b.SetSlot(name, child...)
	return b
}

func (b *VSelectionControlGroupBuilder) ScopedSlot(name string, scope string, child ...h.HTMLComponent) (r *VSelectionControlGroupBuilder) {
	b.SetScopedSlot(name, scope, child...)
	return b
}

func (b *VSelectionControlGroupBuilder) SetSlotDefault(child ...h.HTMLComponent) {
	b.SetSlot("default", child...)
}

func (b *VSelectionControlGroupBuilder) SetScopedSlotDefault(scope string, child ...h.HTMLComponent) {
	b.SetScopedSlot("default", scope, child...)
}

func (b *VSelectionControlGroupBuilder) SlotDefault(child ...h.HTMLComponent) (r *VSelectionControlGroupBuilder) {
	b.SetSlotDefault(child...)
	return b
}

func (b *VSelectionControlGroupBuilder) ScopedSlotDefault(scope string, child ...h.HTMLComponent) (r *VSelectionControlGroupBuilder) {
