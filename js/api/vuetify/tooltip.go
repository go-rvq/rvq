...
func (b *VTooltipBuilder) Interactive(v bool) (r *VTooltipBuilder) {
	b.Attr(":interactive", fmt.Sprint(v))
	return b
}
...
func (b *VTooltipBuilder) SetSlot(name string, child ...h.HTMLComponent) {
	b.AppendChild(h.Template(child...).Attr("v-slot:"+name, true).Attr())
}

func (b *VTooltipBuilder) SetScopedSlot(name string, scope string, child ...h.HTMLComponent) {
	b.AppendChild(h.Template(child...).Attr("v-slot:"+name, scope).Attr())
}

func (b *VTooltipBuilder) Slot(name string, child ...h.HTMLComponent) (r *VTooltipBuilder) {
	b.SetSlot(name, child...)
	return b
}

func (b *VTooltipBuilder) ScopedSlot(name string, scope string, child ...h.HTMLComponent) (r *VTooltipBuilder) {
	b.SetScopedSlot(name, scope, child...)
	return b
}

func (b *VTooltipBuilder) SetSlotDefault(child ...h.HTMLComponent) {
	b.SetSlot("default", child...)
}

func (b *VTooltipBuilder) SetScopedSlotDefault(scope string, child ...h.HTMLComponent) {
	b.SetScopedSlot("default", scope, child...)
}

func (b *VTooltipBuilder) SlotDefault(child ...h.HTMLComponent) (r *VTooltipBuilder) {
	b.SetSlotDefault(child...)
	return b
}

func (b *VTooltipBuilder) ScopedSlotDefault(scope string, child ...h.HTMLComponent) (r *VTooltipBuilder) {
	b.SetScopedSlotDefault(scope, child...)
	return b
}

func (b *VTooltipBuilder) SetSlotActivator(child ...h.HTMLComponent) {
	b.SetSlot("activator", child...)
}

func (b *VTooltipBuilder) SetScopedSlotActivator(scope string, child ...h.HTMLComponent) {
	b.SetScopedSlot("activator", scope, child...)
}

func (b *VTooltipBuilder) SlotActivator(child ...h.HTMLComponent) (r *VTooltipBuilder) {
	b.SetSlotActivator(child...)
	return b
}

func (b *VTooltipBuilder) ScopedSlotActivator(scope string, child ...h.HTMLComponent) (r *VTooltipBuilder) {
